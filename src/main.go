...
func main() {
	...
	case 6:
		day = Day{
			partOne: func(s string) int {
				return day6PartOne(s)
			},
			partTwo: func(s string) int {
				return day6PartTwo(s)
			},
		}
		break
	case 7:
		day = Day{
			partOne: func(s string) int {
				return day7PartOne(s)
			},
			partTwo: func(s string) int {
				return day7PartTwo(s)
			},
		}
		break
	case 8:
		day = Day{
			partOne: func(s string) int {
				return day8PartOne(s)
			},
			partTwo: func(s string) int {
				return day8PartTwo(s)
			},
		}
		break
	case 9:
	...
	case 10:
		day = Day{
			partOne: func(s string) int {
				return day10PartOne(s)
			},
			partTwo: func(s string) int {
				return day10PartTwo(s)
			},
		}
		break
	default:
		panic(fmt.Sprintf("Unknown(or not implemented) day number"+
			" %d please provide a number within 0-25", *dayPtr))
	}
